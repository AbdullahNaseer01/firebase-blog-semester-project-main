            ...
            <div className="flex flex-wrap -m-4">
              <div className="p-4 lg:w-1/2">
                <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                  <img
                    alt="team"
                    className="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4 drop-shadow-xl"
                    src={Abdullah}
                  />
                  <div className="flex-grow sm:pl-8">
                    ...
                    <p className="mb-4">
                      A versatile professional proficient in both front-end and
                      back-end technologies, capable of building end-to-end
                      solutions for optimal website functionality.
                    </p>
              ...
              <div className="p-4 lg:w-1/2">
                <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                  ...
                  <div className="flex-grow sm:pl-8">
                    ...
                    <p className="mb-4">
                      A skilled expert specializing in crafting intuitive user
                      interfaces and engaging user experiences, bringing
                      websites to life with seamless design and interactive
                      elements.
                    </p>
                    <span className="inline-flex">
                      <a className="text-gray-500">
          ...
          /> */}
                  ...
                  <div className="flex-grow sm:pl-8">
                    ...
                    <h3 className="text-gray-500 mb-3">
                      Tester & UI/UX Developer
                    </h3>
                    <p className="mb-4">
                      A versatile professional adept at meticulously testing
                      software for quality assurance while also possessing a
                      creative flair for designing captivating user interfaces
